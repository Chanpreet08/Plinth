...
public class RoboSoccerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("RoboSoccer");
        viewPager = (ViewPager) findViewById(R.id.pager_robosoccer);
